...
window.addEventListener("DOMContentLoaded", ()=>{
  ...
  function whoWinner(){
    ...
    if(r1pos >= 650 || t1pos >= 650){
        ...
        // 메시지 랜덤을 위한 랜덤수 만들기
        // 0~2 사이의 랜덤수
        // 1~3  를 먼저 만든 후 -> Math.random()*3
        // 내림을 하면 0~2e됨! -> Math.floor(Math.random()*3)
        ...
        // 주의사항 : body하위에 새로운 요소를 추가하면 전체 body 직계하위에 있는
        // 요소들에 셋팅된 이벤트가 소실된다!
        // 왜? DOM이 재구조화 되기 때문이다!
